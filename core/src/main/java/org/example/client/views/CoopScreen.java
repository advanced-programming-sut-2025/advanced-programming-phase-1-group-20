...
public class CoopScreen implements Screen {
    ...
    private void loadProductTextures() {
        // Load product textures for coop animals
        String[] products = {"Egg", "Big_Egg", "Duck_Egg", "Duck_Feather", "Rabbit's_Foot"};
    ...
    private void buildUI() {
        ...
        // Title
        mainTable.add(new Label(coop.getName() + " (Capacity: " + coop.getAnimalCount() + "/" + coop.getCapacity() + ")", skin)).colspan(3).pad(20).row();
