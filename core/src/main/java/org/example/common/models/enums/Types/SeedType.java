...
public enum SeedType {
    ...
    AncientSeeds("Ancient Seeds", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN}, 0, "Ancient_Seeds"),
    ...
    CoffeeBean("Coffee Bean", new Seasons[]{Seasons.SPRING, Seasons.SUMMER}, 0, "Coffee_Bean"),
    CornSeeds("Corn Seeds", new Seasons[]{Seasons.SUMMER, Seasons.AUTUMN}, 0, "Corn_Seeds"),
    ...
    SunflowerSeeds("Sunflower Seeds", new Seasons[]{Seasons.SUMMER, Seasons.AUTUMN}, 0, "Sunflower_Seeds"),
    TomatoSeeds("Tomato Seeds", new Seasons[]{Seasons.SUMMER}, 0, "Tomato_Seeds"),
    TulipBulb("Tulip Bulb", new Seasons[]{Seasons.SPRING}, 0, "Tulip_Bulb"),
    WheatSeeds("Wheat Seeds", new Seasons[]{Seasons.SUMMER, Seasons.AUTUMN}, 0, "Wheat_Seeds"),
    YamSeeds("Yam Seeds", new Seasons[]{Seasons.AUTUMN}, 0, "Yam_Seeds"),

    //Tree Seeds & Saplings:
    AppleSapling("Apple Sapling", new Seasons[]{Seasons.AUTUMN}, 0, "Apple_Sapling"),
    ApricotSapling("Apricot Sapling", new Seasons[]{Seasons.SPRING}, 0, "Apricot_Sapling"),
    BananaSapling("Banana Sapling", new Seasons[]{Seasons.SUMMER}, 0, "Banana_Sapling"),
    CherrySapling("Cherry Sapling", new Seasons[]{Seasons.SPRING}, 0, "Cherry_Sapling"),
    MangoSapling("Mango Sapling", new Seasons[]{Seasons.SUMMER}, 0, "Mango_Sapling"),
    OrangeSapling("Orange Sapling", new Seasons[]{Seasons.SUMMER}, 0, "Orange_Sapling"),
    PeachSapling("Peach Sapling", new Seasons[]{Seasons.SUMMER}, 0, "Peach_Sapling"),
    PomegranateSapling("Pomegranate Sapling", new Seasons[]{Seasons.AUTUMN}, 0, "Pomegranate_Sapling"),
    PineCones("Pine Cones", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN, Seasons.WINTER}, 0, "Pine_Cones"),
    Acorns("Acorns", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN, Seasons.WINTER}, 0, "Acorns"),
    MapleSeeds("Maple Seeds", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN, Seasons.WINTER}, 0, "Maple_Seeds"),
    MahoganySeeds("Mahogany Seeds", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN, Seasons.WINTER}, 0, "Mahogany_Seeds"),
    MushroomTreeSeeds("Mushroom Tree Seeds", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN, Seasons.WINTER}, 0, "Mushroom_Tree_Seeds"),
    MysticTreeSeeds("Mystic Tree Seeds", new Seasons[]{Seasons.SPRING, Seasons.SUMMER, Seasons.AUTUMN, Seasons.WINTER}, 0, "Mystic_Tree_Seeds"),
    ;
