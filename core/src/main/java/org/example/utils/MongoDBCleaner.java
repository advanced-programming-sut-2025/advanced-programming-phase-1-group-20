    ...
    private static void clearUsersCollection(MongoDatabase database) {
        try {
            ...
            if (countBefore > 0) {
                ...
                System.out.println("🗑️  Deleted " + countBefore + " users from database");
            } else {
                System.out.println("ℹ️  No users found in database");
            }
        } catch (Exception e) {
    ...
    private static void clearGamesCollection(MongoDatabase database) {
        try {
            ...
            if (countBefore > 0) {
                ...
                System.out.println("🗑️  Deleted " + countBefore + " games from database");
            } else {
                System.out.println("ℹ️  No games found in database");
            }
        } catch (Exception e) {
