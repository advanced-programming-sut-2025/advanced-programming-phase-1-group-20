...
public class WelcomeMenuScreen implements Screen {
    ...
    //TODO : this button is for testing map and game "mostafa"
    private TextButton tryGameButton;
    ...
    private void setupMainMenu() {
        ...
        styleButton(tryGameButton, Color.CYAN);
        ...
        buttonTable.row();
        buttonTable.add(tryGameButton).width(200).height(50).pad(10).colspan(2);
