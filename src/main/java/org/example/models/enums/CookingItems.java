...
import models.Item;
import models.enums.Ingredients;
...
public enum CookingItems {
    ...
    Olmelet("Olmelet", Ingredients.Olmelet.getIngridents(), 100, 125),
    pumpkinpie("pumpkinpie", Ingredients.pumpkinpie.getIngridents(), 225, 385),
    spaghetti("spaghetti", Ingredients.spaghetti.getIngridents(), 75, 120),
    pizza("pizza", Ingredients.pizza.getIngridents(), 150, 300),
    Tortilla("Tortiall", Ingredients.Tortilla.getIngridents(), 50, 50),
    ...
    salmondinner("salamon dinner", Ingredients.salmondinner.getIngridents(), 125, 300),
    vegetablemedley("vegetable medly", Ingredients.vegetablemedley.getIngridents(), 165, 120),
