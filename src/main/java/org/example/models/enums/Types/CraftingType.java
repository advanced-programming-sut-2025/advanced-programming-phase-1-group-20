...
public enum CraftingType {
    CherryBomb("Cherry Bomb", "4 Copper + 1 Coal", "Mining Level 1", 50),
    Bomb("Bomb", "4 Iron + 1 Coal", "Mining Level 2", 50),
    MegaBomb("Mega Bomb", "4 Gold + 1 Coal", "Mining Level 3", 50),
    Sprinkler("Sprinkler", "1 Copper + 1 Iron", "Farming Level 1", 0),
    QualitySprinkler("Quality Sprinkler", "1 Iron + 1 Gold", "Farming Level 2", 0),
    IridiumSprinkler("Iridium Sprinkler", "1 Gold + 1 Iridium", "Farming Level 3", 0),
    CharcoalKlin("Charcoal Klin", "20 Wood + 2 Copper", "Foraging Level 1", 0),
    Furnace("Furnace", "20 Copper + 25 Stone", "-", 0),
    Scarecrow("Scarecrow", "50 Wood + 1 Coal + 20 Fiber", "-", 0),
    DeluxeScarecrow("Deluxe Scarecrow", "50 Wood + 1 Coal + 20 Fiber + 1 Iridium", "Farming Level 2", 0),
    BeeHouse("Bee House", "40 wood + 8 coal + 1 Iron", "Farming Level 1", 0),
    CheesePress("Cheese Press", "45 wood + 45 stone + 1 copper bar", "Farming Level 2", 0),
    Keg("Keg", "30 wood + 1 copper bar + 1 Iron", "Farming Level 3", 0),
